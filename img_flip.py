...
def img_flip(image,type_):
    if type_ == 'h':
        ...
        for line in ori_lines :
            ...
            list_txt[2] = str(round(float(list_txt[2]),6))
            list_txt[3] = str(round(float(list_txt[3]),6))
            list_txt[4] = str(round(float(list_txt[4]),6))
    ...
    if type_ == 'v':
        ...
        for line in ori_lines :
            list_txt = line.split()
            list_txt[1] = str(round(float(list_txt[1]),6))
